...
$ligneId = htmlspecialchars($_POST['id']);
$codeComposant = htmlspecialchars($_POST['codeComposant']);
...
if($ligneId == ''){
	$nbLigneAvantModif =  ajouterLigneAvModif($codeComposant, $fournisseur, $designation, $quantite, $unite, $stock, $prixUnit, $prixTotal, $ficheId);
	header('Location:.?page=fiche&ficheId='.$ficheId);
}else{
	$nbLigneAvantModif = modifierLigneAvModif($ligneId, $codeComposant, $fournisseur, $designation, $quantite, $unite, $stock, $prixUnit, $ficheId);
	header('Location:.?page=fiche&ficheId='.$ficheId);
}
...
if (!empty($results)){
    ...
    if ($validations[0] != NULL){
        ...
        $sheet->setCellValue('B39', dateus2fr($validations[1]));
    ...
    if ($validations[2] != NULL && $validations[3] != NULL){
        ...
        $sheet->setCellValue('I39', dateus2fr($validations[4]));
    ...
    if ($validations[5] != NULL){
        ...
        $sheet->setCellValue('B47', dateus2fr($validations[6]));
    ...
    if ($validations[7] != NULL){
        ...
        $sheet->setCellValue('I47', dateus2fr($validations[8]));
    ...
    if ($validations[9] != NULL){
        ...
        $sheet->setCellValue('B55', dateus2fr($validations[10]));
    ...
    if ($validations[15] != NULL){
        ...
        $sheet->setCellValue('B66', dateus2fr($validations[15]));
    ...
    if ($validations[20] != NULL){
        ...
        $sheet->setCellValue('L63', $validations[19]);
        $sheet->setCellValue('I66', dateus2fr($validations[20]));
