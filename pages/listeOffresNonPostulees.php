...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            Liste des offres non postulées
			...
			<div class="row">
                            <div class="col-sm-12">
                                <?php 
                                    ...
                                    $userDAO = new UserDAO();
                                    $listeOffresNonPostules = $offreDAO->offresNonPostuleesList($_SESSION['idUser']);
                                    ...
                                    echo '<table class="table table-bordered table-hover dataTable">'
                                            ...
                                            . '</thead>'
                                            . '<tbody>';
                                                if (isset($listeOffresNonPostules)){
                                                   foreach ($listeOffresNonPostules as $offre) {
