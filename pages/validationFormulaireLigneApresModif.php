...
if($ligneId == ''){
	$nbLigneApresModif=  ajouterLigneApModif($codeComposant, $fournisseur, $designation, $quantite, $unite, $prixUnit, $prixTotal, $ficheId);
	header('Location:.?page=fiche&ficheId='.$ficheId);
}else{
	$nbLigneApresModif= modifierLigneApModif($ligneId, $codeComposant, $fournisseur, $designation, $quantite, $unite, $prixUnit);
	header('Location:.?page=fiche&ficheId='.$ficheId);
}
