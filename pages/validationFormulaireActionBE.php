...
$majPlanFourn = $_POST['majPlanFourn'];
$majNomenc = $_POST['majNomenc'];
$majModeOp = $_POST['majModeOp'];
$commentairesActionBE = $_POST['commentValiderActionBE'];
$date = date('d/m/Y');

ajoutActionBE($ficheId, $majPlanFourn, $majNomenc, $majModeOp, datefr2us($date), $commentairesActionBE);

$infosFiche = infoFiches($ficheId);

//--------------------------------
//  Mail auto logistique
//--------------------------------

$reqEmailLog = 'SELECT mail '
            . 'FROM utilisateur '
            . 'WHERE idTypeUtilisateur = 7';
$resultEmailLog = Connexion::query($reqEmailLog);
$emailLog = $resultEmailLog[0][0];

mailAutoActionLog($emailLog, $infosFiche);
