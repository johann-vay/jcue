...
$planTransmis = $_POST['planTransmis'];
$commandeModif = $_POST['commandeModif'];
$reintPrev = $_POST['reintPrev'];
$noLR = $_POST['noLR'];
$commentairesActionLog = $_POST['commentValiderActionLog'];

$date = date('Y-m-d');

ajoutActionLog($ficheId, $planTransmis, $commandeModif, $reintPrev, $noLR, $date, $commentairesActionLog);


$infosFiche = infoFiches($ficheId);

//--------------------------------
//  Mail auto Production
//--------------------------------

mailAutoFinCircuitProd($infosFiche);
